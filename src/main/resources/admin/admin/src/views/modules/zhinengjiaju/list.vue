<template>
	<div class="main-content" :style='{"padding":"30px 30px 0"}'>
		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"100%","margin":"0 0 20px"}' :inline="true" :model="searchForm">
				...
				<el-row :style='{"margin":"20px 0","display":"flex"}'>
                    ...
                    <el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(255, 197, 35, 1)","borderRadius":"40px","background":"rgba(90, 67, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zhinengjiaju','上传模板')" type="success" @click="importClcik">上传模板</el-button>
                    <el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(255, 197, 35, 1)","borderRadius":"40px","background":"rgba(90, 67, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zhinengjiaju','下载模板')" type="success" @click="download($base.url + 'upload/zhinengjiaju_template.xlsx')">下载模板</el-button>
					...
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(255, 197, 35, 1)","borderRadius":"40px","background":"rgba(90, 67, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zhinengjiaju','差评情况')" type="warning" @click="chartDialog4()">差评情况</el-button>
					<el-button :style='{"border":"0","cursor":"pointer","padding":"0 24px","margin":"0 10px 0 0","outline":"none","color":"rgba(255, 197, 35, 1)","borderRadius":"40px","background":"rgba(90, 67, 74, 1)","width":"auto","fontSize":"14px","height":"40px"}' v-if="isAuth('zhinengjiaju','智能家居价格')" type="warning" @click="chartDialog5()">智能家居价格</el-button>
				</el-row>
			</el-form>
		...
		<el-dialog
		  ...
		  width="800">
			<div id="chapingshuChart4" style="width:100%;height:600px;"></div>
		  <span slot="footer" class="dialog-footer">
		...
		<el-dialog
		  ...
		  width="800">
			<div id="shangpinjiageChart5" style="width:100%;height:600px;"></div>
		  <span slot="footer" class="dialog-footer">
...
//统计接口
    chartDialog4() {
      ...
      this.$nextTick(()=>{
        ...
        var chapingshuChart4 = echarts.init(document.getElementById("chapingshuChart4"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                chapingshuChart4.setOption(option);
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    chapingshuChart4.resize();
                };
            }
        });
      })
...
//统计接口
    chartDialog5() {
      ...
      this.$nextTick(()=>{
        ...
        var shangpinjiageChart5 = echarts.init(document.getElementById("shangpinjiageChart5"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                shangpinjiageChart5.setOption(option);
                  //根据窗口的大小变动图表
                window.onresize = function() {
                    shangpinjiageChart5.resize();
                };
            }
        });
      })
