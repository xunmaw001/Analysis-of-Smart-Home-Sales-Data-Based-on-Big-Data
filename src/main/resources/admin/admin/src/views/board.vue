<template>
<div class="content box8" :style='{"alignContent":"flex-start","minHeight":"100vh","flexWrap":"wrap","background":"url(http://codegen.caihongy.cn/20230313/0b043a1da9554748b9083dd40edbb09a.jpg) no-repeat center top / 100% 100%,#040e29","display":"flex","width":"100%","position":"relative","height":"auto"}'>
	<!-- 标题 -->
	<div :style='{"margin":"0 0 30px 0","color":"#fff","textAlign":"center","background":"url(http://codegen.caihongy.cn/20230313/fe57f0b8c78743c0abbf639c96b7bebb.gif) no-repeat center top / 100% 100%","width":"100%","lineHeight":"110px","fontSize":"24px","height":"105px","order":"0"}'>欢迎使用 {{this.$project.projectName}}</div>
	<!-- 时间 -->
	<div :style='{"top":"0","color":"#fff","display":"inline-block","lineHeight":"69px","fontSize":"16px","position":"absolute","right":"5%","height":"69px"}' class="times">{{ dates }}</div>
	<!-- 系统简介 -->
	<div v-if="systemIntroductionDetail" :style='{"padding":"0px","margin":"0 1% 20px 3%","top":"135px","flexWrap":"wrap","background":"none","flexDirection":"column","display":"flex","width":"30%","position":"absolute","height":"auto","order":"1"}'>
		<el-carousel :style='{"width":"100%","margin":"0 auto","height":"350px"}' trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal" height="350px" :autoplay="true" :interval="3000" :loop="true">
			<el-carousel-item :style='{"borderRadius":"0px","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture1">
				<el-image :style='{"objectFit":"cover","width":"100%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture1" fit="cover"></el-image>
			</el-carousel-item>
			<el-carousel-item :style='{"borderRadius":"0px","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture2">
				<el-image :style='{"objectFit":"cover","width":"100%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture2" fit="cover"></el-image>
			</el-carousel-item>
			<el-carousel-item :style='{"borderRadius":"0px","width":"100%","height":"100%"}' v-if="systemIntroductionDetail.picture3">
				<el-image :style='{"objectFit":"cover","width":"100%","height":"100%"}' :src="$base.url+ systemIntroductionDetail.picture3" fit="cover"></el-image>
			</el-carousel-item>
		</el-carousel>
		<div :style='{"padding":"20px","margin":"30px 0 0","borderColor":"#007aac","overflow":"hidden","color":"#eee","borderWidth":"2px","width":"100%","lineHeight":"24px","fontSize":"14px","borderStyle":"solid","textIndent":"2em","height":"350px"}' v-html="systemIntroductionDetail.content"></div>
	</div>
	<!-- 统计 -->
	<div :style='{"alignContent":"flex-start","padding":"20px","margin":"0px 1% 20px 3%","borderColor":"#007aac","flexWrap":"wrap","background":"rgba(255,255,255,.1)","borderWidth":"2px","display":"flex","width":"30%","borderStyle":"solid","height":"350px","order":"4"}'>

		<div :style='{"margin":"0 0 20px","alignItems":"center","borderRadius":"20px","background":"rgba(255,255,255,.1)","display":"flex","width":"100%","justifyContent":"center"}'>
			<div :style='{"width":"32px","borderRadius":"100%","background":"#409abf","height":"32px"}'></div>
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"14px","color":"#fff","height":"32px"}'>冰箱信息总数</div>
				<div :style='{"lineHeight":"32px","fontSize":"18px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{bingxiangxinxiCount}}</div>
			</div>
		</div>


		<div :style='{"margin":"0 0 20px","alignItems":"center","borderRadius":"20px","background":"rgba(255,255,255,.2)","display":"flex","width":"100%","justifyContent":"center"}'>
			<div :style='{"width":"32px","borderRadius":"100%","background":"#40bf88","height":"32px"}'></div>
			<div :style='{"padding":"0 20px","alignItems":"center","flex":"1","justifyContent":"space-between","display":"flex"}'>
				<div :style='{"lineHeight":"32px","fontSize":"14px","color":"#fff","height":"32px"}'>智能家居总数</div>
				<div :style='{"lineHeight":"32px","fontSize":"18px","color":"#fff","fontWeight":"bold","height":"32px"}'>{{zhinengjiajuCount}}</div>
			</div>
		</div>
	...
	<div class="tables">
		<div :style='{"margin":"0 0 20px 0","color":"#fff","textAlign":"center","background":"rgba(255,255,255,.1)","width":"100%","lineHeight":"64px","fontSize":"28px","height":"64px"}'>冰箱信息</div>
        <el-table :data="boardDataList" border :stripe="false" :style='{"width":"100%","padding":"0","borderColor":"#333","borderStyle":"solid","borderWidth":"1px 0 0 1px","background":"none"}'>
          <el-table-column :resizable="true" :sortable="true" prop="fengmian" label="封面">
          ...
          <el-table-column :resizable="true" :sortable="true" prop="jiage" label="价格"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="pinpai" label="品牌"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="spmc" label="商品名称"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="spcd" label="商品产地"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="nxdj" label="能效等级"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="mks" label="门款式"/>
          </el-table-column>
          <el-table-column :resizable="true" :sortable="true" prop="zlfs" label="制冷方式"/>
          </el-table-column>
        </el-table>
	</div>

            <div class="echarts1">
                <div id="bingxiangxinxiChart1" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts2">
                <div id="bingxiangxinxiChart2" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts3">
                <div id="bingxiangxinxiChart3" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts4">
                <div id="zhinengjiajuChart4" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts5">
                <div id="zhinengjiajuChart5" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts6">
                <div id="zhinengjiajuChart6" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts7">
                <div id="zhinengjiajuChart7" style="width:100%;height:100%;"></div>
            </div>
            <div class="echarts8">
                <div id="zhinengjiajuChart8" style="width:100%;height:100%;"></div>
            </div>
...
export default {
  ...
  mounted(){
    ...
    this.zhinengjiajuChat6();
    this.zhinengjiajuChat7();
    this.zhinengjiajuChat8();
  },
  created() {
    this.$nextTick(()=>{
		this.times()
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, bingxiangxinxiChart1)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(2, option.yAxis.data, option.series[0].data, bingxiangxinxiChart3)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, zhinengjiajuChart4)
      ...
      this.$nextTick(()=>{
        ...
        this.$http({
            ...
            if (data && data.code === 0) {
				...
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, zhinengjiajuChart5)
...
//统计接口3
    zhinengjiajuChat6() {
      this.$nextTick(()=>{
        ...
        var zhinengjiajuChart6 = echarts.init(document.getElementById("zhinengjiajuChart6"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                zhinengjiajuChart6.setOption(option);
				

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    zhinengjiajuChart6.resize();
                };
            }
        });
      })
...
//统计接口4
    zhinengjiajuChat7() {
      this.$nextTick(()=>{
        ...
        var zhinengjiajuChart7 = echarts.init(document.getElementById("zhinengjiajuChart7"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                zhinengjiajuChart7.setOption(option);
				
				this.myChartInterval(1, option.xAxis.data, option.series[0].data, zhinengjiajuChart7)

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    zhinengjiajuChart7.resize();
                };
            }
        });
      })
...
//统计接口5
    zhinengjiajuChat8() {
      this.$nextTick(()=>{
        ...
        var zhinengjiajuChart8 = echarts.init(document.getElementById("zhinengjiajuChart8"),'macarons');
        this.$http({
            ...
            if (data && data.code === 0) {
                ...
                // 使用刚指定的配置项和数据显示图表。
                zhinengjiajuChart8.setOption(option);

				this.myChartInterval(1, option.xAxis.data, option.series[0].data, zhinengjiajuChart8)

                  //根据窗口的大小变动图表
                window.onresize = function() {
                    zhinengjiajuChart8.resize();
                };
            }
        });
      })
...
<style lang="scss" scoped>
	...
	.box8 .tables {
				padding: 20px;
				margin: 0 3% 30px 3%;
				background: url(http://codegen.caihongy.cn/20230313/df9c1dc550e44f6faaeae064269c65a4.gif) no-repeat center top / 100% 100%;
				width: 94%;
				transition: 0.3s;
				height: auto;
				order: 18;
	...
	.box8 .echarts1 {
				padding: 20px;
				margin: 0 1% 30px 35%;
				background: url(http://codegen.caihongy.cn/20230313/59b776781e0d415ab1bdd6bad1ed6f60.gif) no-repeat center top / 100% 100%;
				width: 30%;
				transition: 0.3s;
				height: 350px;
				order: 3;
	...
	// table
	.box8 .el-table /deep/ .el-table__header-wrapper thead {
				color: #999;
				font-weight: 500;
				width: 100%;
			}
	
	.box8 .el-table /deep/ .el-table__header-wrapper thead tr {
				background: none;
			}
	
	.box8 .el-table /deep/ .el-table__header-wrapper thead tr th {
				padding: 6px 0;
				background: none;
				border-color: #333;
	...
	.box8 .el-table /deep/ .el-table__header-wrapper thead tr th .cell {
				padding: 0 10px;
				word-wrap: normal;
	...
	.box8 .el-table /deep/ .el-table__body-wrapper tbody {
				width: 100%;
			}
	
	.box8 .el-table /deep/ .el-table__body-wrapper tbody tr {
				background: none;
			}
	
	.box8 .el-table /deep/ .el-table__body-wrapper tbody tr td {
				padding: 6px 0;
				color: #ccc;
				background: none;
				border-color: #333;
	...
	.box8 .el-table /deep/ .el-table__body-wrapper tbody tr:hover td {
				padding: 6px 0;
				color: #ccc;
				background: none;
				border-color: #333;
	...
	.box8 .el-table /deep/ .el-table__body-wrapper tbody tr td .cell {
				padding: 0 10px;
				overflow: hidden;
				word-break: break-all;
				white-space: normal;
